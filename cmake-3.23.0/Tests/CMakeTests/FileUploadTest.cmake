file(REMOVE_RECURSE "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads")

if(EXISTS "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads")

set(filename "/root/anroid/cmake-3.23.0/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/root/anroid/cmake-3.23.0/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/anroid/cmake-3.23.0/Tests/CMakeTests/uploads/file2.png"
